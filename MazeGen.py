...
class Maze:
	...
	def branch(self): #create a new "branch" or passage through the maze
	...
	def join(self, cellA, cellB): #connect the two cells, adding their intersection to the maze path
